                    ...
                    <div class="customer-page">
                        ...
                        <form method="POST" action="{{ route('register') }}" class="form-customer form-login">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control form-account" id="name" name="name" :value="old('name')" required autofocus autocomplete="name" />
                                @error('name')
                            ...
                            <div class="form-group">
                                ...
                                <input type="email" class="form-control form-account" id="email" name="email" :value="old('email')" required autocomplete="username" />
                                @error('email')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
