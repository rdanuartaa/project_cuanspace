                        ...
                        <div class="card card-rounded">
                            <div class="card-body">
                                <div class="d-sm-flex justify-content-between align-items-start">
                                    ...
                                    <div>
                                        <a href="{{ route('admin.sellers.index') }}" class="btn btn-primary btn-lg text-white mb-0 me-0" type="button"><i class="mdi mdi-account-plus"></i>Lihat Semua Penjual</a>
                                    </div>
                                </div>
                                        ...
                                        <tbody>
                                            @forelse ($sellers as $seller)
                                                <tr>
                                                    <td>
                                                        <div class="d-flex">
                                                            <img src="{{ Storage::url($seller->profile_image) }}" alt="profil" class="img-sm rounded-10">
                                                            <div>
                                                    ...
                                                    <td>
                                                        ...
                                                        @elseif ($seller->status == 'active')
                                                            ...
                                                            <form action="{{ route('admin.sellers.setPending', $seller->id) }}" method="POST" style="display:inline;">
                                                                @csrf
                                                                <button type="submit" class="btn btn-warning btn-sm">Set Menunggu</button>
                                                            </form>
                                        ...
                                        <div class="mt-3">
                                            @forelse ($topSellers as $topSeller)
                                                <div class="wrapper d-flex align-items-center justify-content-between py-2 border-bottom">
                                                    <div class="d-flex">
                                                        <img class="img-sm rounded-10" src="{{ Storage::url($topSeller->profile_image) }}" alt="profil">
                                                        <div class="wrapper ms-3">
                                                            <p class="ms-1 mb-1 fw-bold">{{ $topSeller->user->name ?? 'N/A' }}</p>
