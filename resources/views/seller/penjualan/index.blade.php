                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        @if($trx->product->thumbnail && file_exists(public_path('storage/' . $trx->product->thumbnail)))
                                            <img src="{{ asset('storage/' . $trx->product->thumbnail) }}" alt="{{ $trx->product->name }}"
                                ...
                                <td>
                                    <a href="{{ route('seller.penjualan.show', $trx->id) }}" class="btn btn-outline-info btn-sm">Detail</a>
                                </td>
                            </tr>
                        @empty
                            <tr>
